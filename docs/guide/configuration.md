...
Output:
```
2025-11-22T10:30:45Z INFO Glory Hole DNS starting version=0.7.1
...
Output:
```json
{"time":"2025-11-22T10:30:45Z","level":"INFO","msg":"Glory Hole DNS starting","version":"0.7.1"}
...
telemetry:
  ...
  service_version: "0.7.1"         # Version string
