...
Output:
```
2025-11-22T10:30:45Z INFO Glory Hole DNS starting version=0.6.0
...
Output:
```json
{"time":"2025-11-22T10:30:45Z","level":"INFO","msg":"Glory Hole DNS starting","version":"0.6.0"}
...
telemetry:
  ...
  service_version: "0.6.0"         # Version string
