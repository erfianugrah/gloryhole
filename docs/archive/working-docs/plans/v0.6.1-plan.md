...
**The "Legacy" Problem**: We're calling config fields "legacy" at v0.7.1, which is confusing since we're pre-1.0. We can make breaking changes guilt-free in 0.x versions!

**The Linter Problem**: We disabled 7 linters to ship v0.7.1 quickly. This created technical debt. Time to pay it down.
